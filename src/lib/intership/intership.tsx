export const internships = [
  {
    ...
    openlab:["Openlab programme","In CERN openlab’s summer program, participants will engage in advanced projects alongside CERN collaborators for nine weeks, gaining hands-on experience with the latest computing technologies. https://openlab.cern/education/cern-openlab-summer-student-programme"],
